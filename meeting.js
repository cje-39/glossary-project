            ...
            html += `
                <div class="meeting-item" onclick="window.meetingManager && window.meetingManager.viewMeeting('${meeting.id}')">
                    ...
                    <div style="margin-top: 12px;">
                        ...
                        <div style="background: white; border: 1px solid #e0e0e0; border-radius: 6px; padding: 0 4px; white-space: pre-wrap; line-height: 1.3; display: inline-block; width: 100%; color: #333;">
                    ...
                    <div style="margin-top: 12px;">
                        ...
                        <div style="background: white; border: 1px solid #e0e0e0; border-radius: 6px; padding: 0 4px; white-space: pre-wrap; line-height: 1.3; display: inline-block; width: 100%; color: #666;">
